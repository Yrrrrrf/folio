#import "@local/folio:0.0.1": deliverables-register, folio-init

#show: body => folio-init(
  data: (
    registers: (
      deliverables_register: (
        (id: "D1", description: "Demo Deliverable", owner: "Team A", due_date: "2026-05-01", status: "Planned", req_ids: ("REQ-01",)),
      )
    ),
    baselines: (
