...
#import "../phases/inicio.typ": cover, pitch, business_case, objectives
...
#let pmbok-pipeline = (
  ...
  (phase: "initiation", section_id: "business_case", data_path: "initiation.business_case", render_fn: business_case),
  ...
  (phase: "execution", section_id: "status_report", data_path: "execution.status", render_fn: status_report),
  (phase: "execution", section_id: "risk_matrix", data_path: "registers.risk_register", render_fn: risk_matrix),
  (phase: "execution", section_id: "issue_log", data_path: "registers.issue_log", render_fn: issue_log),
  (phase: "execution", section_id: "change_log", data_path: "registers.change_log", render_fn: change_log),
  (phase: "closure", section_id: "lessons_learned", data_path: "closure.lessons_learned", render_fn: lessons_learned),
  (phase: "closure", section_id: "sign_off", data_path: "closure.sign_off", render_fn: sign_off),
)
