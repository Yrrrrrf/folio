#let baselines-defaults = (
  ...
  financials: (budget_items: (), contingency_reserve: 0, payment_terms: (), projections: (), bom: ()),
  quality: (tech_requirements: (), functional: (), non_functional: (), acceptance_criteria: (), testing: (), qa_plan: (:)),
