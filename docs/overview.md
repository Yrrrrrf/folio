...
- **📋 Single Source of Truth:** Define your project once in `dt.typ` and every
  document stays in sync automatically.
- **📄 Full PM Document Suite:** Covers the complete project lifecycle — from
  charter and feasibility all the way through to closure.
- **📊 Built-in Gantt Charts:** Auto-generated timeline visualizations from your
  phase and milestone data.
- **🎨 Consistent Branding:** A unified design system (colors, typography, page
  layout) across every generated document.
- **⚡ Zero Boilerplate:** Import the package, point it at your data, call the
  function — done.
- **🔧 Flexible & Composable:** Generate all documents or just the ones you
  need, in any order.
...
You now have a complete, consistently branded project management PDF ready to
share.
...
All document content is driven by fields on the `project` dictionary. Every
field is optional unless the document that uses it is called — Folio simply
renders what you provide.
