...
#show: project-doc(
  data: (
    ...
    initiation: (
      ...
      success_criteria: (
        (id: "SC-1", type: "project", criterion: "All links clickable, zero orphans", measurement: "Orphan count", target: "0", objective_id: "OBJ-1"),
      ),
      stakeholders: (
    ...
    baselines: (
      ...
      requirements: (
        (id: "REQ-01", description: "Label emission for every entity", category: "Correctness", priority: "high", qty: 1, unit: "feature", unit_cost: 0),
      ),
      schedule: (
        milestones: (
    ...
    registers: (
      risk_register: (
        (id: "R1", description: "Package not installed locally", mitigation: "Run `just local` first", probability: "Low", impact: "High", status: "Open", source_assumption: "A-2"),
      ),
      issue_log: (
        (id: "I1", description: "Orphan ref detected", owner: "CI", status: "Open", blocks_deliverable: ("D1",)),
      ),
      change_log: (
        (id: "C1", description: "Added new label families", status: "Approved", type: "scope", affects_baseline: "baselines.scope"),
      ),
      decision_log: (
        (id: "DEC-1", description: "Use slugify for label IDs", date: "2026-04-01", decision_maker: "Architect", rationale: "Avoids special-char collisions.", reversibility: "Type-2", prompted_by_risk: "R1"),
      ),
      deliverables_register: (
        (id: "D1", description: "All label families green", owner: "Dev", due_date: "2026-05-01", status: "Planned", req_ids: ("REQ-01",)),
      ),
    ),
    closure: (
      lessons_learned: (
        (category: "Architecture", issue: "Labels must be emitted before links resolve", recommendation: "Always emit labels in the same pass as the data table row"),
      ),
      acceptance: (
