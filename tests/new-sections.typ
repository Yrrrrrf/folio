...
#import "@local/folio:0.0.1": (
  folio-init,
  success-criteria, stakeholders, assumptions-log,
  requirements, quality, communication, risk-strategy, compliance,
  budget, gantt,
  decision-log, deliverables-register,
  acceptance, benefits-review, handover, financial-closure,
)
...
#show: body => folio-init(
  data: (
    initiation: (
      ...
      success_criteria: (
        (id: "SC-1", type: "project", criterion: "All features shipped", measurement: "Feature count", target: "10", objective_id: "OBJ-1"),
    ...
    baselines: (
      requirements: (
        (id: "REQ-01", description: "Core API",        category: "Backend",  priority: "high",   qty: 1, unit: "module", unit_cost: 15000),
        (id: "REQ-02", description: "Dashboard UI",    category: "Frontend", priority: "medium", qty: 1, unit: "module", unit_cost: 8000),
        (id: "REQ-03", description: "Hosting (1 yr)",  category: "Infra",    priority: "high",   qty: 12, unit: "months", unit_cost: 500),
      ),
      quality: (
      ...
      communication: (
        (what: "Sprint review",  audience: "All stakeholders", frequency: "Bi-weekly", channel: "Video call",   owner: "PM"),
      ...
      compliance: (
        (id: "COMP-1", regulation: "GDPR",        jurisdiction: "EU",    req_ids: ("REQ-01",), status: "Compliant",    audit_date: "2026-01-15"),
        (id: "COMP-2", regulation: "SOC 2 Type I", jurisdiction: "US",    req_ids: (),          status: "Pending"),
      ),
      financials: (
        budget: (
          line_items: (
            (id: "BUD-01", description: "Core API dev",    category: "Backend",  qty: 1,  unit: "module", unit_cost: 15000, req_id: "REQ-01"),
            (id: "BUD-02", description: "Dashboard dev",   category: "Frontend", qty: 1,  unit: "module", unit_cost: 8000,  req_id: "REQ-02"),
            (id: "BUD-03", description: "Cloud hosting",   category: "Infra",    qty: 12, unit: "months", unit_cost: 500,   req_id: "REQ-03"),
          ),
          extra_costs: (
    ...
    registers: (
      risk_register: (
        (id: "R1", description: "Budget overrun", mitigation: "Weekly burn tracking", probability: "Medium", impact: "High", status: "Open", source_assumption: "A-3"),
      ),
      deliverables_register: (
        (id: "D1", description: "Core API v1.0",     owner: "Backend team",  due_date: "2026-07-01", status: "In-Progress", req_ids: ("REQ-01",)),
        (id: "D2", description: "Dashboard v1.0",    owner: "Frontend team", due_date: "2026-08-01", status: "Planned",     req_ids: ("REQ-02",)),
      ),
      decision_log: (
        (id: "DEC-1", description: "Use PostgreSQL over MongoDB", date: "2026-05-05", decision_maker: "Tech Lead", rationale: "Team expertise and ACID compliance.", reversibility: "Type-2", prompted_by_risk: "R1"),
        (id: "DEC-2", description: "Skip mobile app for v1",      date: "2026-05-10", decision_maker: "Alice",     rationale: "Out of scope per budget cap."),
      ),
    ),
    closure: (
      acceptance: (
      ...
      benefits_review: (
        (objective_id: "OBJ-1", claimed: "10 features shipped", actual: "11 features shipped", variance: "+10%", root_cause: "Team velocity higher than estimated"),
      ),
      handover: (
